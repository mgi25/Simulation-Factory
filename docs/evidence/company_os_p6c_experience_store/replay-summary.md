...
| precedent_found | 11 |
| abstained | 23 |
| abstentions_by_code | {"incompatible_only": 10, "no_match": 8, "stale_only": 5} |
...
| precedent_rows_with_captured_outcome | 9 |
| precedent_rows_where_top1_changed_a_file_the_task_changed | 9 |
| precedent_rows_where_the_task_ended_accepted | 8 |
| rows_with_warnings | 7 |
| rows_with_warnings_that_ended_as_corrections | 1 |
| candidates_excluded_by_reason | {"below_floor": 197, "incompatible": 109, "invalid": 1, "not_yet_settled": 401, "stale": 44} |
| suggestions_refused_total | 19 |
| suggestions_refused_by_read_authority | 19 |
| same_day_episodes_excluded_total | 138 |
| advice_chars_max | 5211 |
| advice_chars_median | 746 |
| eligible_history_bytes_max | 572610 |
| latency_ms_median | 148.205 |
| latency_ms_max | 511.459 |
...
| 2026-09-19 | wo-req-ceo-page-attempts-remaining | 1 | 2 | precedent | wo-ceo-2026-09-18-attempts-remaining-consumer |  |  | accepted |
...
| 2026-09-21 | wo-token-efficiency-v4-p2-benchmark-contract-correction | 1 | 8 | abstain (stale_only) |  |  |  | accepted |
| 2026-09-21 | wo-token-efficiency-v4-p2-review-test-ownership-v2 | 1 | 8 | abstain (no_match) |  |  |  | correction |
| 2026-09-21 | wo-token-efficiency-v4-p3-benchmark-contract-correction | 1 | 8 | abstain (stale_only) |  |  |  | correction |
| 2026-09-21 | wo-token-efficiency-v4-p3c-benchmark-contract-correction | 1 | 8 | abstain (stale_only) |  |  |  | accepted |
...
| 2026-09-24 | wo-p5-read-authority-correction-b | 1 | 22 | abstain (stale_only) |  |  |  | not_captured |
| 2026-09-24 | wo-p5-read-authority-evidence-suite | 1 | 22 | abstain (stale_only) |  |  |  | not_captured |
