...
from .execution_cli import add_parsers as add_execution_parsers
from .execution_cli import handle as handle_execution_command
...
def build_parser() -> argparse.ArgumentParser:
    ...
    add_execution_parsers(subparsers)
    return parser
    ...
    try:
        ...
        if args.command == "validate":
            ...
            for employee_id, employee in sorted(
                config.org_registry["employees"].items()
            ):
