...
class EngineeringResult:
    ...
    def __post_init__(self) -> None:
        ...
        if isinstance(self.developer_attempts, bool) or not isinstance(
    ...
    def build(
        ...
        *,
        ...
        return cls(
            ...
            developer_attempts_remaining=job.corrections_remaining,
            tests=tuple(tests),
    ...
    def render_text(self) -> str:
        ...
        remaining_str = "unknown" if self.developer_attempts_remaining is None else str(self.developer_attempts_remaining)
        lines.append(f"  developer attempts: {self.developer_attempts}  remaining: {remaining_str}")
