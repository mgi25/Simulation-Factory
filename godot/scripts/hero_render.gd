...
## Offline renderer for the final hero build. Stills or a short clip.
##
...
##     --dump-modules=PATH    also write the module anchor table as JSON

const LabScene := preload("res://scripts/hero_scene.gd")
...
func _fail(message: String) -> void:
	push_error("hero render failed: %s" % message)
	get_tree().quit(1)
